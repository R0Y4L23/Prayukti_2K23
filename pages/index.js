      ...
      <div className="slide-in-bck-center home relative min-h-screen"> 
       <div className='absolute top-0 bg-black h-screen w-full bg-opacity-60'>
          ...
          <div className="flex flex-row justify-between items-center min-[740px]:mx-20 min-[520px]:mx-8 mx-2 min-[1024px]:-translate-y-12 z-20">
            ...
            <p className="text-white min-[1024px]:text-[30px] uppercase font-[100] min-[650px]:tracking-[10px] text-xl cursor-pointer hover:tracking-[20px] hover:text-[40px] duration-500 glitch z-20 -translate-y-1" onClick={() => {if(loggedIn)
                            {
            ...
            <img src={"assets/images/logo.png"} alt="logo" className="min-[1024px]:w-[300px] min-[400px]:w-[180px] w-[150px] z-20 -translate-y-1" />
            <img src={"assets/images/riviera_logo.png"} alt="logo" className="min-[1024px]:w-[300px] min-[400px]:w-[180px] w-[150px] z-20 -translate-y-1" />
            <div className='c1:block hidden'>
            <p className="text-white min-[1024px]:text-[30px] uppercase font-[100] min-[650px]:tracking-[10px] text-xl cursor-pointer hover:tracking-[20px] hover:text-[40px] duration-500 glitch z-20 -translate-y-1" onClick={() => { router.push("/events") }}>Events</p>
            </div>
          </div>
          ...
          <p onClick={()=>{router.push("/events")}} className="text-center min-[1024px]:text-[30px] text-[25px] text-white gravity mt-10 tracking-[10px]  z-20 min-[768px]:-translate-y-1 -translate-y-12 hover:tracking-[15px] hover:text-[40px] duration-500 cursor-pointer">The Era Of Virtual Veda</p>
